...
(function() {
  ...
  window.Avispa = (function(superClass) {
    extend(Avispa, superClass);
    ...
    Avispa.prototype.Scale = function(scale1) {
      this.scale = scale1;
  ...
  Avispa.Group = (function(superClass) {
  ...
  Avispa.Node = (function(superClass) {
  ...
  Avispa.Link = (function(superClass) {
    ...
    Link.prototype.initialize = function(options1) {
      this.options = options1;
    ...
    Link.prototype.Drag = function(event) {
      var d, from_x, from_y, ref, to_x, to_y, x, y;
      ref = context.Point(event), x = ref[0], y = ref[1];
